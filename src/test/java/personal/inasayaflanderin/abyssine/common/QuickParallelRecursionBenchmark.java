...
@State(Scope.Thread)
public class QuickParallelRecursionBenchmark {
	...
	@Fork(1)
	public void quickParallelRecursion(Blackhole bh) {
		Sort.quickParallelRecursion(subject, Double::compareTo, 0, subject.length);
		bh.consume(subject);
	}
}
