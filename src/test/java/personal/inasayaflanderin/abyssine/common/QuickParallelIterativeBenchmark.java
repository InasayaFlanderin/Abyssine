...
@State(Scope.Thread)
public class QuickParallelIterativeBenchmark {
	...
	@Fork(1)
	public void quickParallelIterative(Blackhole bh) {
		Sort.quickParallelIterative(subject, Double::compareTo, 0, subject.length);
		bh.consume(subject);
	}
}
